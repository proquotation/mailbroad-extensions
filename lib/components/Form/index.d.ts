...
export declare const SliderField: (props: import("./enhancer").EnhancerProps & Omit<SliderProps, "value" | "onChange" | "mutators">) => import("react").JSX.Element;
...
export declare const TreeSelectField: (props: import("./enhancer").EnhancerProps & Omit<TreeSelectProps, "value" | "onChange" | "mutators">) => import("react").JSX.Element;
export declare const AutoCompleteField: (props: import("./enhancer").EnhancerProps & Omit<AutoCompleteProps, "value" | "onChange" | "mutators">) => import("react").JSX.Element;
export declare const RadioGroupField: (props: import("./enhancer").EnhancerProps & Omit<RadioGroupProps, "value" | "onChange" | "mutators">) => import("react").JSX.Element;
export declare const SwitchField: (props: import("./enhancer").EnhancerProps & Omit<SwitchProps, "value" | "onChange" | "mutators">) => import("react").JSX.Element;
export declare const CheckboxField: (props: import("./enhancer").EnhancerProps & Omit<CheckboxGroupProps<any>, "value" | "onChange" | "mutators">) => import("react").JSX.Element;
export declare const EditTabField: (props: import("./enhancer").EnhancerProps & Omit<EditTabProps<any>, "value" | "onChange" | "mutators">) => import("react").JSX.Element;
export declare const EditGridTabField: (props: import("./enhancer").EnhancerProps & Omit<EditGridTabProps<any>, "value" | "onChange" | "mutators">) => import("react").JSX.Element;
export declare const InlineTextField: (props: import("./enhancer").EnhancerProps & Omit<InlineTextProps, "value" | "onChange" | "mutators">) => import("react").JSX.Element;
